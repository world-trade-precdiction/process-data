...
unprocessed_materials = list(range(28, 41)) + list(range(72, 84))

filtered_df = df[(df["refPeriodId"] >= 2000) & (df["refPeriodId"] <= 2021)]
...
df_pivot = df_pivot.sort_index(axis=1, level=["year", "import_or_export"])
